...
function EmailMetaDataModal({
  ...
  return (
    <DialogContent aria-describedby={undefined} className="!suprsend-max-w-3xl !suprsend-max-h-[90vh] !suprsend-border-0 !suprsend-p-0 !suprsend-gap-0 suprsend-overflow-hidden">
      <DialogHeader className="suprsend-pb-2 suprsend-pt-6 suprsend-px-6">
        <DialogTitle className="suprsend-pb-2">Email Settings</DialogTitle>
      </DialogHeader>

      <div className="suprsend-space-y-6 suprsend-overflow-y-auto suprsend-flex-1 suprsend-min-h-0 suprsend-px-6 suprsend-pb-4">
      ...
      <DialogFooter className="suprsend-border-t suprsend-pt-4 suprsend-pb-6 suprsend-px-6">
